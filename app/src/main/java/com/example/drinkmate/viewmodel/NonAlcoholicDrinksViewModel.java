...
public class NonAlcoholicDrinksViewModel extends ViewModel {

    private static final String TAG = "NonAlcoholicDrinksVM";
    ...
    public NonAlcoholicDrinksViewModel() {
    ...
    public void fetchNonAlcoholicDrinks() {
        isLoadingLiveData.setValue(true);
        errorMessageLiveData.setValue(null);

        apiService.filterByAlcoholic("Non_Alcoholic").enqueue(new Callback<DrinksResponse>() {
            @Override
            public void onResponse(Call<DrinksResponse> call, Response<DrinksResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (drinks != null && !drinks.isEmpty()) {
                        ...
                        errorMessageLiveData.setValue("No non-alcoholic drinks found.");
                    }
                } else {
                    Log.e(TAG, "API Response not successful. Code: " + response.code());
                    drinksLiveData.setValue(Collections.emptyList());
                    errorMessageLiveData.setValue("Error fetching non-alcoholic drinks. Code: " + response.code());
                }
            }
